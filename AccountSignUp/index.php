 ...
 * Class:       AD 320
 * Title:       index.php (lab 5, ex07_01)
 * Date:        Jan 31, 2018
 * Attachment:  display_results.php 
 *              main.css
 * 
 * This program is a kind of Contact page. It will allow a user to create
 *  an account and decide if they would like to subscribe to updates, and
 *  even leave a text comment.
 */
-->
